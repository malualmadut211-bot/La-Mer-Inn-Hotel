...
export default function AboutCTA() {
  ...
  const headingText = "Experience La Mer Inn for Yourself".split(" ");
  ...
  return (
    <section className="relative w-full min-h-[350px] lg:min-h-[450px] overflow-hidden">
      ...
      <div className="absolute top-[-1px] left-0 w-[200%] z-30 h-[50px] lg:h-[80px] rotate-180">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-full fill-primary animate-[wave-shift_10s_linear_infinite]">
      ...
      <div className="relative z-20 max-w-[700px] mx-auto px-6 py-[100px] lg:py-[120px] flex flex-col justify-center items-center text-center h-full">
        ...
        >
          From our lush garden to our warm smiles, everything about La Mer Inn is designed to make you feel at home. Come discover why guests keep coming back.
        </motion.p>
