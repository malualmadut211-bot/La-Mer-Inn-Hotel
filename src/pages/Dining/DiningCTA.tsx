...
export default function DiningCTA() {
  ...
  const headingText = "Reserve Your Table".split(" ");

  return (
    <section id="dining-reservations" className="relative w-full min-h-[350px] lg:min-h-[450px] overflow-hidden">
      {/* SVG Wave Top Edge */}
      ...
      <div className="relative z-20 max-w-[700px] mx-auto px-6 py-[100px] lg:py-[120px] flex flex-col justify-center items-center text-center h-full">
        ...
        >
          Join us for an unforgettable dining experience. Whether it's a romantic dinner, a business lunch, or a family gathering, we look forward to serving you.
        </motion.p>
