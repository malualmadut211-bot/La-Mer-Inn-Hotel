...
export default function AmenitiesCTA() {
  ...
  const headingText = "Experience the Difference".split(" ");
  ...
  return (
    <section className="relative w-full min-h-[350px] lg:min-h-[450px] overflow-hidden">
      ...
      <div className="relative z-20 max-w-[700px] mx-auto px-6 py-[100px] lg:py-[120px] flex flex-col justify-center items-center text-center h-full">
        ...
        >
          Enjoy all these amenities and more when you stay at La Mer Inn. Book your room today and let us take care of the rest.
        </motion.p>
