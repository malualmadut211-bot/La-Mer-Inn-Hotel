...
export default function AmenitiesHero() {
  ...
  const headingText = "Hotel Amenities".split(" ");
  ...
  return (
    <section className="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
      ...
      <div className="relative z-20 h-full max-w-[1280px] mx-auto px-6 lg:px-20 flex flex-col justify-center items-start pt-20">
        ...
        >
          From high-speed connectivity to relaxing garden spaces, discover the facilities designed to make your stay effortless and enjoyable.
        </motion.p>
        ...
        >
          <button 
            onClick={() => document.getElementById('core-amenities')?.scrollIntoView({ behavior: 'smooth' })}
          ...
          >
            <span className="relative z-10 group-hover:text-primary transition-colors duration-300">Explore Facilities</span>
